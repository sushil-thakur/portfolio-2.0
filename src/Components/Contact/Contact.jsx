        ...
        >
          <Step>
            <div className="text-center space-y-6">
              <h2 className="text-6xl md:text-8xl font-bold text-black" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                LET'S CONNECT
              </h2>
          ...
          <Step>
            <div className="text-center space-y-8">
              <h2 className="text-5xl md:text-7xl font-bold text-black mb-8" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                REACH OUT TO ME
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full px-8">
                ...
                >
                  <svg className="w-16 h-16 mb-4 text-black transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <h3 className="text-xl font-semibold text-black " style={{ fontFamily: 'Bebas Neue, sans-serif' }}>GitHub</h3>
                ...
                <a 
                  ...
                  className="group flex flex-col items-center p-6 bg-gray-100 rounded-xl hover:bg-gray-200 transition-all duration-300 hover:scale-105 shadow-lg"
                >
                  <svg className="w-16 h-16 mb-4 text-black group-hover:text-blue-600 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                  <h3 className="text-xl font-semibold text-black group-hover:text-blue-600" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>LinkedIn</h3>
                ...
                <a 
                  ...
                  className="group flex flex-col items-center p-6 bg-gray-100 rounded-xl hover:bg-gray-200 transition-all duration-300 hover:scale-105 shadow-lg"
                >
                  <svg className="w-16 h-16 mb-4 text-black group-hover:text-red-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 7.89a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <h3 className="text-xl font-semibold text-black group-hover:text-red-600" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>Email</h3>
                  <p className="text-gray-600">anuj505@gmail.com</p>
                </a>
              </div>
            </div>
          </Step>
          ...
          <Step>
            <div className="text-center space-y-6">
              <h2 className="text-5xl md:text-7xl font-bold text-black mb-6" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                SEND ME A MESSAGE
              </h2>
